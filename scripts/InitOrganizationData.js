	...
	for(i in data){
        ...
        if(typeof(data[i].children) === 'object'){ // An array will return 'object'
            if(isSub && data[i].children.length){
                html += '<span data-id="' + data[i].Id + '" data-type="' + data[i].NodeType + '">' + data[i].name + '</span>';
            } else {
				if (data[i].NodeType == "Employee")
					html += '<span data-type="' + data[i].NodeType + '">' + data[i].name + '<br><span class="positionType">' + data[i].PositionTypeName + '</span></span>'; //data[i].Id; // Submenu found, but top level list i.
				else
					html += '<span data-type="' + data[i].NodeType + '">' + data[i].name + '</span>'; //data[i].Id; // Submenu found, but top level list i.
            }
